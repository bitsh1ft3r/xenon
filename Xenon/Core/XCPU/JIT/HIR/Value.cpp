...
#define SUB_DID_CARRY(a, b) (b == 0 || a > (~(0 - b)))
      ...
      void Value::VectorConvertI2F(Value *other, bool is_unsigned) {
        ...
        for (int i = 0; i < 4; i++) {
          if (is_unsigned) {
            constant.v128.flt[i] = (float)other->constant.v128.dword[i];
          }
          else {
            constant.v128.flt[i] = (float)other->constant.v128.dsword[i];
          }
        }
      }
      ...
      void Value::VectorConvertF2I(Value *other, bool is_unsigned) {
        ...
        for (int i = 0; i < 4; i++) {
          if (is_unsigned) {
            constant.v128.dword[i] = (uint32_t)other->constant.v128.flt[i];
          }
          else {
            constant.v128.dsword[i] = (int32_t)other->constant.v128.flt[i];
          }
        }
      }
        ...
        case INT8_TYPE:
          if (saturate) {
            for (int i = 0; i < 16; i++) {
              if (is_unsigned) {
                constant.v128.bytes[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.bytes[i], other->constant.v128.bytes[i]);
              }
              else {
                constant.v128.sbytes[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.sbytes[i], other->constant.v128.sbytes[i]);
              }
            }
        ...
        case INT16_TYPE:
          if (saturate) {
            for (int i = 0; i < 8; i++) {
              if (is_unsigned) {
                constant.v128.word[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.word[i], other->constant.v128.word[i]);
              }
              else {
                constant.v128.sword[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.sword[i], other->constant.v128.sword[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
        ...
        case INT32_TYPE:
          if (saturate) {
            for (int i = 0; i < 4; i++) {
              if (is_unsigned) {
                constant.v128.dword[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.dword[i], other->constant.v128.dword[i]);
              }
              else {
                constant.v128.dsword[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.dsword[i], other->constant.v128.dsword[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
        ...
        case INT64_TYPE:
          if (saturate) {
            for (int i = 0; i < 2; i++) {
              if (is_unsigned) {
                constant.v128.qword[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.qword[i], other->constant.v128.qword[i]);
              }
              else {
                constant.v128.qsword[i] =
                  Base::MathUtils::SaturateAdd(constant.v128.qsword[i], other->constant.v128.qsword[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
        ...
        case INT8_TYPE:
          if (saturate) {
            for (int i = 0; i < 16; i++) {
              if (is_unsigned) {
                constant.v128.bytes[i] =
                  Base::MathUtils::SaturateSub(constant.v128.bytes[i], other->constant.v128.bytes[i]);
              }
              else {
                constant.v128.sbytes[i] =
                  Base::MathUtils::SaturateSub(constant.v128.sbytes[i], other->constant.v128.sbytes[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
        ...
        case INT16_TYPE:
          if (saturate) {
            for (int i = 0; i < 8; i++) {
              if (is_unsigned) {
                constant.v128.word[i] =
                  Base::MathUtils::SaturateSub(constant.v128.word[i], other->constant.v128.word[i]);
              }
              else {
                constant.v128.sword[i] =
                  Base::MathUtils::SaturateSub(constant.v128.sword[i], other->constant.v128.sword[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
        ...
        case INT32_TYPE:
          if (saturate) {
            for (int i = 0; i < 4; i++) {
              if (is_unsigned) {
                constant.v128.dword[i] =
                  Base::MathUtils::SaturateSub(constant.v128.dword[i], other->constant.v128.dword[i]);
              }
              else {
                constant.v128.dsword[i] =
                  Base::MathUtils::SaturateSub(constant.v128.dsword[i], other->constant.v128.dsword[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
        ...
        case INT64_TYPE:
          if (saturate) {
            for (int i = 0; i < 2; i++) {
              if (is_unsigned) {
                constant.v128.qword[i] =
                  Base::MathUtils::SaturateSub(constant.v128.qword[i], other->constant.v128.qword[i]);
              }
              else {
                constant.v128.qsword[i] =
                  Base::MathUtils::SaturateSub(constant.v128.qsword[i], other->constant.v128.qsword[i]);
              }
            }
            // TODO(Triang3l): Trace DID_SATURATE.
          }
      ...
      void Value::VectorAverage(Value *other, TypeName type, bool is_unsigned,
        ...
        case INT8_TYPE: {
          for (int i = 0; i < 16; i++) {
            if (is_unsigned) {
              constant.v128.bytes[i] =
                uint8_t((uint16_t(constant.v128.bytes[i]) +
                  uint16_t(other->constant.v128.bytes[i]) + 1) >>
                  1);
            }
            else {
              constant.v128.sbytes[i] =
                int8_t((int16_t(constant.v128.sbytes[i]) +
                  int16_t(other->constant.v128.sbytes[i]) + 1) >>
                  1);
            }
          }
        } break;
        case INT16_TYPE: {
          for (int i = 0; i < 8; i++) {
            if (is_unsigned) {
              constant.v128.word[i] =
                uint16_t((uint32_t(constant.v128.word[i]) +
                  uint32_t(other->constant.v128.word[i]) + 1) >>
                  1);
            }
            else {
              constant.v128.sword[i] =
                int16_t((int32_t(constant.v128.sword[i]) +
                  int32_t(other->constant.v128.sword[i]) + 1) >>
                  1);
            }
          }
        } break;
        case INT32_TYPE: {
          for (int i = 0; i < 4; i++) {
            if (is_unsigned) {
              constant.v128.dword[i] =
                uint32_t((uint64_t(constant.v128.dword[i]) +
                  uint64_t(other->constant.v128.dword[i]) + 1) >>
                  1);
            }
            else {
              constant.v128.dsword[i] =
                int32_t((int64_t(constant.v128.dsword[i]) +
                  int64_t(other->constant.v128.dsword[i]) + 1) >>
                  1);
            }
          }
        } break;
